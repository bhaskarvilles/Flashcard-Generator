      ...
      {flashcard.length > 0 ? (
        <div>
          ...
          <div className="flex justify-end mr-10">
            <button
              className="w-16 mt-1 font-semibold text-lg text-blue-600 outline-none border-none active:outline-none active:border-none"
        ...
        <div className="flex items-center justify-center bg-grey shadow-lg p-20">
