...
const CreateFlashCard = () => {
  ...
  return (
    <Formik
      // This sets the Initial Values of form input for the Formik, which wil after being change according to the user Input
      initialValues={{
        groupid: nanoid(),
        groupname: "",
        groupdescription: "",
                    ...
                    {cards && cards.length > 0
                      ? cards.map((card, index) => (
                          <div
                            ...
                            key={index}
                          >
                            <div className="p-2 w-10 h-10 flex items-center justify-center bg-blue-600 text-white text-md font-semibold rounded-full">
                              {index + 1}
                            </div>
